    ...
    <div class="row">
        <form action="{{ route('events.confirm') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="discription" value="{{ old('discription') }}" class="form-control @error('discription') is-invalid @enderror" rows="3" id="textarea" aria-describedby="">{{ old('discription') }}</textarea>
                    @error('discription')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="event_time_discription" value="{{ old('event_time_discription') }}" class="form-control  @error('event_time_discription') is-invalid @enderror" id="textarea" aria-describedby="">{{ old('event_time_discription') }}</textarea>
