            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <form class="d-flex" role="search" method="GET" action="{{ route('events.keyword') }}">
                        ...
                        <button type="submit" class="btn btn-outline-success flex-shrink-0"><i class="fas fa-search"></i></button>
                    </form>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        ...
                        @endif
                    @else
                        <div class="bd-highlight"><a class="btn" href="{{ route('events.select') }}" role="button">イベントを作成</a></div>
                        <li class="nav-item dropdown">
